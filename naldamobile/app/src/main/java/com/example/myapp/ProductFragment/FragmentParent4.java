...
public class FragmentParent4 extends Fragment {
...
//    private int port = 1001;
    ...
    TextView chatTV_f4;
    ImageButton reserveNow_f4, orderNow_f4, addCart_f4, cancel_f4;

    TextView amountText_f4, price1_f4;
    int amountCnt = 1;
    String menu_count = "01";
    String pdt_name = "레몬에이드";
    String pdt_price = "4300";
...
//    String reserve_flag = "Y";
    ...
    Button amountDown_f4, amountUp_f4;
...
//    ProductActivity pa = new ProductActivity();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Inflate the layout for this fragment / return 을 View view = 로 수정하고 밑에 두줄 추가
        View view = inflater.inflate(R.layout.fragment_parent4, container, false);
        mHandler = new Handler();

        amountDown_f4 = (Button) view.findViewById(R.id.amountDown_f4);
        amountUp_f4 = (Button) view.findViewById(R.id.amountUp_f4);

        amountText_f4 = (TextView) view.findViewById(R.id.amountText_f4);
        price1_f4 = (TextView) view.findViewById(R.id.price1_f4);

        orderNow_f4 = (ImageButton) view.findViewById(R.id.orderNow_f4);
        reserveNow_f4 = (ImageButton) view.findViewById(R.id.reserveNow_f4);
        addCart_f4 = (ImageButton) view.findViewById(R.id.addCart_f4);
        cancel_f4 = (ImageButton) view.findViewById(R.id.cancel_f4);
        chatTV_f4 = (TextView) view.findViewById(R.id.chatTV_f4);

        amountCnt = Integer.parseInt(amountText_f4.getText().toString());

        models = new ArrayList<>();
        models.add(new ProductImageModel(R.drawable.pdt_ade_1, "레몬에이드", "4300"));
        models.add(new ProductImageModel(R.drawable.pdt_ade_2, "자몽에이드", "4300"));
        models.add(new ProductImageModel(R.drawable.pdt_ade_3, "청포도에이드", "4300"));
        models.add(new ProductImageModel(R.drawable.pdt_ade_4, "딸기주스", "5000"));
        ...
        // 지점오픈여부
//        if(open_flag == "N"){orderNow_f4.setEnabled(false);}
//        else{ orderNow_f4.setEnabled(true); }
        orderNow_f4.setOnClickListener(new View.OnClickListener(){
            @Override
        ...
        // 예약하기 버튼
        if(ProductActivity.reserve_text.contains("예약 불가능")){reserveNow_f4.setEnabled(false);}
        else{reserveNow_f4.setEnabled(true);}
        reserveNow_f4.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
        ...
        addCart_f4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                getActivity().finish();
            }
        ...
        cancel_f4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                getActivity().finish();
            }
        ...
        price1_f4.setText("가격 : "+pdt_price+" 원");
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener(){
            ...
            public void onPageSelected(int position) {
                ...
                amountText_f4.setText(""+amountCnt);
                price1_f4.setText("가격 : "+pdt_price+" 원");
        ...
        amountDown_f4.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                if(amountCnt <= 1){amountCnt = 1;}
                    ...
                    price1_f4.setText("가격 : "+(total_price)+" 원");
                }
                amountText_f4.setText(""+amountCnt);
            }
        });

        amountUp_f4.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
...
//                sndMsg = getStringToByte(sndMsg);
    ...
    class msgUpdate implements Runnable {
        ...
        public void run() {
            chatTV_f4.setText(chatTV_f4.getText().toString() + msg + "\n");
            if((chatTV_f4.getText().toString()).contains("STXMS0400")){
...
//        String dataCount = "12";
    ...
    class msgUpdateReserve implements Runnable{
        ...
        public void run() {
            chatTV_f4.setText(chatTV_f4.getText().toString() + msg + "\n");
            if((chatTV_f4.getText().toString()).contains("STXMS0500")){
                // 예약 완료
                Intent payjoa = new Intent(getActivity().getApplicationContext(), PaymentActivity.class);
                payjoa.putExtra("member_id",ProductActivity.member_id);
                payjoa.putExtra("shop_name",ProductActivity.shop_name);
