...
public class ThreeFragment extends Fragment {
    ...
    int images[] = {R.drawable.shop3, R.drawable.shop2, R.drawable.shop3, R.drawable.shop4, R.drawable.shop5, R.drawable.shop1};
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        shop_name = getResources().getStringArray(R.array.incheon_shopname);
        address1 = getResources().getStringArray(R.array.incheon_address1);
        address2 = getResources().getStringArray(R.array.incheon_address2);
        order_text = getResources().getStringArray(R.array.incheon_order_text);
        reserve_text = getResources().getStringArray(R.array.incheon_reserve_text);

        shopRecycler = getView().findViewById(R.id.rv_3);
